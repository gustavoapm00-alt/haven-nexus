...
| `SUPABASE_FUNCTIONS_URL` | *(your Supabase Functions URL — found in Lovable Cloud project settings)* |
...
```
POST https://<YOUR_SUPABASE_PROJECT_REF>.supabase.co/functions/v1/agent-heartbeat
```
