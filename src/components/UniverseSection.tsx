...
const divisions = [{
  ...
  icon: Building2,
  title: 'Aerelion Housing & Development',
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl mb-4">
              THE AERELION <span className="text-gradient">UNIVERSE</span>
            </h2>
