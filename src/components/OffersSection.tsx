...
const offers = [
  {
    ...
    includes: [
      'Custom AI agents for research and outreach',
      'Automated workflows for content, lead gen, or operations',
      'Strategy sessions to map your tech stack and systems',
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      'Product page and homepage strategy',
      'Basic automations and app stack recommendations',
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      'Basic funnel (Instagram → offer → booking)',
      'Simple tech stack you can actually maintain',
    ],
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {offers.map((offer) => {
            ...
            return (
              <div
                key={offer.title}
                className="card-glow p-8 rounded-sm border border-border/50 flex flex-col hover:border-primary/30 transition-all duration-500"
              >
